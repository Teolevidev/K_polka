...
export interface IngestBookPayload {
  ...
  query?: string;
  /**
   * Прямая ссылка на карточку книги у издательства.
   *
   * Самый точный вход из всех: берем данные оттуда, где книга заведомо
   * есть и заведомо описана правильно. Ради современной русской прозы
   * это и сделано - у Google и OpenLibrary свежая книга Редакции Елены
   * Шубиной либо отсутствует, либо лежит без обложки и аннотации.
   */
  url?: string;
}
