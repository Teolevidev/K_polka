<!--
  Внешний документ, приложен заказчиком 2026-09-09 как опорный стиль
  («хочу полностью такой же сайт»). Сохранен дословно, без правок -
  включая длинные тире и оригинальную английскую формулировку.
  Как он переведен в код - см. docs/design-system.md.
-->
